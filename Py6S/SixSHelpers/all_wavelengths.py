...
class Wavelengths:
    ...
    def run_s2b_msi(cls, s, **kwargs):
        ...
        * ``output_name`` -- (Optional) The output to extract from ``s.outputs``, as a string that could be placed after ``s.outputs.``, for example ``pixel_reflectance``
        ...
        or a list of values of the selected output if ``output_name`` is set.
        """
        wv = [PredefinedWavelengths.S2B_SR_AV_B01,
              PredefinedWavelengths.S2B_SR_AV_B02,
              PredefinedWavelengths.S2B_SR_AV_B03,
              PredefinedWavelengths.S2B_SR_AV_B04,
              PredefinedWavelengths.S2B_SR_AV_B05,
              PredefinedWavelengths.S2B_SR_AV_B06,
              PredefinedWavelengths.S2B_SR_AV_B07,
              PredefinedWavelengths.S2B_SR_AV_B08,
              PredefinedWavelengths.S2B_SR_AV_B09,
              PredefinedWavelengths.S2B_SR_AV_B10,
              PredefinedWavelengths.S2B_SR_AV_B11,
              PredefinedWavelengths.S2B_SR_AV_B12,
              PredefinedWavelengths.S2B_SR_AV_B13]
